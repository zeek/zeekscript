...
age_d = interval_to_double(network_time() - cert$not_valid_before) / 86400.0; #@ annotation

age_d = interval_to_double(network_time() - cert$not_valid_before) / 86400.0;
...
return some_very_long_variable_name in some_other_very_long_variable_name && another_thing in yet_another_thing;
