...
static const std::unordered_map<std::string, TagEntry> tag_map = {
	...
	{"FOR-COND", {Tag::ForCond, false}},
	{"FOR-COND-VAL", {Tag::ForCondVal, false}},
	{"FOR-COND-BRACKET", {Tag::ForCondBracket, false}},
	{"FOR-COND-BRACKET-VAL", {Tag::ForCondBracketVal, false}},
